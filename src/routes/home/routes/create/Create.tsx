...
const CreatePage = () => {
    ...
    return (
        <section className="h-full flex flex-col pr-8 py-12 container mx-auto max-w-7xl">
            <div>
            ...
            <div className="h-full w-full shadow rounded-xl overflow-hidden grid grid-cols-2 border mt-8">
                <CreateForm input={input} setInput={setInput} />
                <CreateImages input={input} setInput={setInput} />
            </div>
        </section>
    );
}
